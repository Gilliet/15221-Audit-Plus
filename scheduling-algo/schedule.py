...
class Course:
    def __init__(self, name, number, units, prereqs, coreqs):
        self.name = name
        self.number = number
        self.units = units
...
Course("Formal Languages, Automata, and Computability", 15453, 9, [[21228], [15251]], [])
Course("Undergraduate Complexity Theory", 15455, 9, [[15251]], [])
Course("Combinatorics", 21301, 9, [[21122,21228],[21122,15251]], [])
Course("Graph Theory", 21484, 9, [[21228,21241],[21228,21242],[15251,21241],[15251,21241]], [])
# Applications
...
Course("Machine Learning", 10601, 12, [[15122,21127],[15122,15151]], [[21325],[15359],[36225],[36217]])
Course("Natural Language Processing", 11411, 12, [[15122]], [])
Course("Foundations of Software Engineering", 15313, 12, [[15214]], [])
Course("Introduction to Computer Music", 15322, 9, [[15112]], [])
Course("Computer Music Systems and Information Processing", 15323, 9, [[15122]], [])
Course("Artificial Intelligence: Representation and Problem Solving", 15381, 9, [[15122, 15211]], [])
Course("Database Applications", 15415, 12, [[15210],[15211, 15213]], [])
Course("Computer Graphics", 15462, 12, [[21259, 15213, 21241],[15213,18202]], [])
Course("Robot Kinematics and Dynamics", 16384, 12, [[15122],[18202],[24311],[21241],[16311]],[])
Course("Computer Vision", 16385, 9, [[18202,15122],[15122,21259,21241]], []) 
# Logics/Languages
Course("Foundations of Programming Languages", 15312, 12, [[15210,15251],[15212]], [])
Course("Constructive Logic", 15317, 9, [[15210],[15212]], [])
Course("Bug Catching: Automated Program Verification and Testing", 15414, 9, [[15122, 15251],[15211,15251]],[])
Course("Special Topic: Foundations of Cyber-Physical Systems", 15424, 12, [[15122, 15251, 21122]], [])
Course("Basic Logic", 21-300, 9, [[15251],[21228],[21373]], [] )
Course("Undecidability and Incompleteness", 80311, 9, [[80210],[80211],[21300],[80310],[15251]], [])
# Software Systems
Course("Operating System Design and Implementation", 15410, 12, [[15213]], [])
Course("Compiler Design", 15411, 12, [[15213],[15312]], [])
Course("Parallel Computer Architecture and Programming", 15418, 12, [[15213]], [])
Course("Distributed Systems", 15440, 12, [[15213]], [])
Course("Computer Networks", 15441, 12, [[15213]], [])
# Mathematics
Course("Differential and Integral Calculus", 21120, 10, [], [])
Course("Integration, Differential Equations and Approximation", 21122, 10, [[21112],[21120]], [])
Course("Concepts of Mathematics", 21127, 10, [], [])
Course("Matrices and Linear Transformations", 21241, 10, [], [])
Course("Matrix Theory", 21242, 10, [], [])
# Probability
Course("Probability and Computing", 15359, 12, [[15251, 21259, 21241]], [])
