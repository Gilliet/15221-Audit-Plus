...
Returns: Prints out an schedule generated by problem.py
"""
...
def interpretInput(takenClassesString, incorrectMessage):
...
def generateSchedule():
    ...
    # Since we couldn't get arguments in from the website, just pass in a list
    # with Freshman Immigration Course for now
